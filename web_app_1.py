    ...
    try:
        ...
        if doc_parser is None:
            doc_parser = DocumentParser(
                vl_api_key=os.getenv("QWEN_VL_API_KEY", "EMPTY"),
                vl_base_url=os.getenv("QWEN_VL_BASE_URL", "http://xn-d.suanjiayun.com:57915/v1"),
                vl_model=os.getenv("QWEN_VL_MODEL", "Qwen/Qwen3-VL-235B-A22B-Instruct-FP8")
            )
